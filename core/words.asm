...
WordID_1027_Entry: ; *** nip ***
  pop  hl
  pop  bc
  jp   (hl)
WordID_1027_Exit:

WordID_1028_Entry: ; *** not ***
  pop  hl
  ld   a,d
  or   e
  ld   de,$0000
